...
export enum InvalidDataReason {
  ...
  POOL_RETIREMENT_INVALID_POOL_KEY = 'invalid pool key hash or pool key path in a pool registration certificate',
  ...
  SIGN_MODE_ORDINARY__POOL_RETIREMENT_POOL_KEY_ONLY_AS_PATH = 'pool retirement pool key must be given as a path in TransactionSigningMode.ORDINARY_TRANSACTION',
  ...
  SIGN_MODE_POOL_PAYER__DATUM_NOT_ALLOWED = 'datum in outputs not allowed in TransactionSigningMode.POOL_REGISTRATION_AS_PAYER',
  SIGN_MODE_POOL_PAYER__REFERENCE_SCRIPT_NOT_ALLOWED = 'reference script in outputs not allowed in TransactionSigningMode.POOL_REGISTRATION_AS_PAYER',
  SIGN_MODE_POOL_PAYER__SINGLE_POOL_REG_CERTIFICATE_REQUIRED = 'single pool registration certificate is expected in TransactionSigningMode.POOL_REGISTRATION_AS_PAYER',
  SIGN_MODE_POOL_PAYER__THIRD_PARTY_POOL_KEY_REQUIRED = 'third party pool key is required in TransactionSigningMode.POOL_REGISTRATION_AS_PAYER',
  SIGN_MODE_POOL_PAYER__DEVICE_OWNED_POOL_OWNER_NOT_ALLOWED = 'device-owned pool owner not expected in TransactionSigningMode.POOL_REGISTRATION_AS_PAYER',
  SIGN_MODE_POOL_PAYER__WITHDRAWALS_NOT_ALLOWED = 'withdrawals not allowed in TransactionSigningMode.POOL_REGISTRATION_AS_PAYER',
  SIGN_MODE_POOL_PAYER__MINT_NOT_ALLOWED = 'mint not allowed in TransactionSigningMode.POOL_REGISTRATION_AS_PAYER',
  SIGN_MODE_POOL_PAYER__SCRIPT_DATA_HASH_NOT_ALLOWED = 'script data hash not allowed in TransactionSigningMode.POOL_REGISTRATION_AS_PAYER',
  SIGN_MODE_POOL_PAYER__COLLATERAL_INPUTS_NOT_ALLOWED = 'collateral inputs not allowed in TransactionSigningMode.POOL_REGISTRATION_AS_PAYER',
  SIGN_MODE_POOL_PAYER__COLLATERAL_OUTPUT_NOT_ALLOWED = 'collateral output not allowed in TransactionSigningMode.POOL_REGISTRATION_AS_PAYER',
  SIGN_MODE_POOL_PAYER__TOTAL_COLLATERAL_NOT_ALLOWED = 'total collateral not allowed in TransactionSigningMode.POOL_REGISTRATION_AS_PAYER',
  SIGN_MODE_POOL_PAYER__REQUIRED_SIGNERS_NOT_ALLOWED = 'required signers not allowed in TransactionSigningMode.POOL_REGISTRATION_AS_PAYER',
  SIGN_MODE_POOL_PAYER__REFERENCE_INPUTS_NOT_ALLOWED = 'reference inputs not allowed in TransactionSigningMode.POOL_REGISTRATION_AS_PAYER',
  SIGN_MODE_POOL_PAYER__VOTING_PROCEDURES_NOT_ALLOWED = 'voting procedures not allowed in TransactionSigningMode.POOL_REGISTRATION_AS_PAYER',
  SIGN_MODE_POOL_PAYER__TREASURY_NOT_ALLOWED = 'treasury amount not allowed in TransactionSigningMode.POOL_REGISTRATION_AS_PAYER',
  SIGN_MODE_POOL_PAYER__DONATION_NOT_ALLOWED = 'treasury donation not allowed in TransactionSigningMode.POOL_REGISTRATION_AS_PAYER',

  SIGN_MODE_POOL_RETIREMENT_PAYER__DATUM_NOT_ALLOWED = 'datum in outputs not allowed in TransactionSigningMode.POOL_RETIREMENT_AS_PAYER',
  SIGN_MODE_POOL_RETIREMENT_PAYER__REFERENCE_SCRIPT_NOT_ALLOWED = 'reference script in outputs not allowed in TransactionSigningMode.POOL_RETIREMENT_AS_PAYER',
  SIGN_MODE_POOL_RETIREMENT_PAYER__ONLY_POOL_RETIREMENT_CERTIFICATES_ALLOWED = 'only pool retirement certificates are expected in TransactionSigningMode.POOL_RETIREMENT_AS_PAYER',
  SIGN_MODE_POOL_RETIREMENT_PAYER__POOL_KEY_HASH_REQUIRED = 'pool key hash is required in TransactionSigningMode.POOL_RETIREMENT_AS_PAYER',
  SIGN_MODE_POOL_RETIREMENT_PAYER__WITHDRAWALS_NOT_ALLOWED = 'withdrawals not allowed in TransactionSigningMode.POOL_RETIREMENT_AS_PAYER',
  SIGN_MODE_POOL_RETIREMENT_PAYER__MINT_NOT_ALLOWED = 'mint not allowed in TransactionSigningMode.POOL_RETIREMENT_AS_PAYER',
  SIGN_MODE_POOL_RETIREMENT_PAYER__SCRIPT_DATA_HASH_NOT_ALLOWED = 'script data hash not allowed in TransactionSigningMode.POOL_RETIREMENT_AS_PAYER',
  SIGN_MODE_POOL_RETIREMENT_PAYER__COLLATERAL_INPUTS_NOT_ALLOWED = 'collateral inputs not allowed in TransactionSigningMode.POOL_RETIREMENT_AS_PAYER',
  SIGN_MODE_POOL_RETIREMENT_PAYER__COLLATERAL_OUTPUT_NOT_ALLOWED = 'collateral output not allowed in TransactionSigningMode.POOL_RETIREMENT_AS_PAYER',
  SIGN_MODE_POOL_RETIREMENT_PAYER__TOTAL_COLLATERAL_NOT_ALLOWED = 'total collateral not allowed in TransactionSigningMode.POOL_RETIREMENT_AS_PAYER',
  SIGN_MODE_POOL_RETIREMENT_PAYER__REQUIRED_SIGNERS_NOT_ALLOWED = 'required signers not allowed in TransactionSigningMode.POOL_RETIREMENT_AS_PAYER',
  SIGN_MODE_POOL_RETIREMENT_PAYER__REFERENCE_INPUTS_NOT_ALLOWED = 'reference inputs not allowed in TransactionSigningMode.POOL_RETIREMENT_AS_PAYER',
  SIGN_MODE_POOL_RETIREMENT_PAYER__VOTING_PROCEDURES_NOT_ALLOWED = 'voting procedures not allowed in TransactionSigningMode.POOL_RETIREMENT_AS_PAYER',
  SIGN_MODE_POOL_RETIREMENT_PAYER__TREASURY_NOT_ALLOWED = 'treasury amount not allowed in TransactionSigningMode.POOL_RETIREMENT_AS_PAYER',
  SIGN_MODE_POOL_RETIREMENT_PAYER__DONATION_NOT_ALLOWED = 'treasury donation not allowed in TransactionSigningMode.POOL_RETIREMENT_AS_PAYER',
  ...
  SIGN_MODE_PLUTUS__POOL_RETIREMENT_POOL_KEY_ONLY_AS_PATH = 'pool retirement pool key must be given as a path in TransactionSigningMode.PLUTUS_TRANSACTION',
  ...
  SIGN_MODE_UNRESTRICTED__POOL_RETIREMENT_POOL_KEY_ONLY_AS_PATH = 'pool retirement pool key must be given as a path in TransactionSigningMode.UNRESTRICTED_TRANSACTION',
  ...
  DERIVE_NATIVE_SCRIPT_HASH_DEPTH_LIMIT_EXCEEDED = 'native script exceeds maximum supported nesting depth',
