...
export enum InvalidDataReason {
  ...
  CVOTE_REGISTRATION_INCONSISTENT_WITH_CIP15 = "CIP36 voting registration params inconsistent with CIP-15",
  CVOTE_REGISTRATION_INCONSISTENT_WITH_CIP36 = "CIP36 voting registration params inconsistent with CIP-36",
  CVOTE_REGISTRATION_BOTH_KEY_AND_PATH = "CIP36 voting key given both as a key and as a derivation path",
  CVOTE_REGISTRATION_MISSING_VOTING_KEY = "CIP36 voting key missing",
  CVOTE_REGISTRATION_INVALID_VOTING_KEY = "invalid CIP36 voting registration voting key",
  CVOTE_REGISTRATION_INVALID_VOTING_KEY_PATH = "invalid CIP36 voting registration voting key path",
  CVOTE_REGISTRATION_INVALID_STAKING_KEY_PATH = "invalid CIP36 voting registration staking key path",
  CVOTE_REGISTRATION_INVALID_NONCE = "invalid CIP36 voting registration nonce",
  CVOTE_REGISTRATION_INVALID_VOTING_PURPOSE = "invalid CIP36 voting registration voting purpose",
  CVOTE_REGISTRATION_DELEGATIONS_NOT_ARRAY = "CIP36 voting registration delegations not an array",
  CVOTE_DELEGATION_UNKNOWN_FORMAT = "invalid CIP36 voting delegation format",
  CVOTE_DELEGATION_UNKNOWN_DELEGATION_TYPE = "invalid CIP36 voting delegation type",
  CVOTE_DELEGATION_INVALID_WEIGHT = "invalid CIP36 voting delegation weight",
  CVOTE_DELEGATION_INVALID_PATH = "invalid CIP36 voting delegation path",
  CVOTE_DELEGATION_INVALID_KEY = "invalid CIP36 voting delegation key",
