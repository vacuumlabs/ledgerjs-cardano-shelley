...
export function parseCVote(
    ...
    const voteCastDataHex = parseHexString(cVote.voteCastDataHex, InvalidDataReason.GOVERNANCE_VOTE_INVALID_VOTECAST_DATA)
    ...
    const witnessPath = parseBIP32Path(cVote.witnessPath, InvalidDataReason.GOVERNANCE_VOTE_INVALID_WITNESS)
