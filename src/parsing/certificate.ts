...
import { CertificateType, MultisigIdentifierType, MultisigIdentifier2, KEY_HASH_LENGTH, SCRIPT_HASH_LENGTH } from "../types/internal"
import type { Certificate, MultisigIdentifier } from "../types/public"
import { parseBIP32Path, parseHexStringOfLength, parseUint64_str, parseMultisigIdentifier, validate } from "../utils/parse"
...
export function parseCertificate(cert: Certificate): ParsedCertificate {
    ...
    case CertificateType.STAKE_DEREGISTRATION: {
        ...
        return {
            type: cert.type,
            identifier: parseMultisigIdentifier(cert.params.identifier, InvalidDataReason.CERTIFICATE_INVALID_SCRIPT_HASH)
        }
    }
