...
export const poolRegistrationOwnerRejectTestCases: TestCaseRejectShelley[] = [
  ...
  },
  {
    ...
    err: {
      ...
      v8: {errCls: DeviceStatusError, errMsg: DoNotRunOnLedger},
    }, // it would be finnicky bypassing this check in the js code
...
export const invalidRelayTestCases: TestCaseRejectShelley[] = [
  ...
  },
  {
    ...
    rejectReason: InvalidDataReason.RELAY_SINGLE_HOST_IP_MISSING_BOTH_ADDRESSES,
  },
]
