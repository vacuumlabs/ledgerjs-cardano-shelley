import { Certificate, MultiHostRelayParams, PoolKeyType, PoolMetadataParams, PoolOwner, PoolRegistrationParams, PoolRewardAccount, PoolRewardAccountType, Relay, SignedTransactionData, SingleHostHostnameRelayParams, Transaction, TxInput, TxOutput, Withdrawal } from "../../../src/Ada";
...
> = {
  ...
  poolRewardAccountHash: {
    ...
    params: {
      keyHashHex: "e1794d9b3408c9fb67b950a48a0690f070f117e9978f7fc1d120fc58ad"
    }
  }
}
...
export const poolRegistrationTestcases: Testcase[] = [
  ...
  {
    testname: "Should correctly witness pool retirement",
    tx: {
      ...txBase,
      certificates: [certificates.poolRetirement],
    },
    result: {
      // WARNING: only as computed by ledger, not verified with cardano-cli
