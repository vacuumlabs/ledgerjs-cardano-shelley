...
const poolKeys: Record<'poolKeyPath' | 'poolKeyHash', PoolKey> = {
  poolKeyPath: {
...
const stakingHashOwners: Record<'owner0' | 'owner1', PoolOwner> = {
  owner0: {
...
const stakingPathOwners: Record<'owner0' | 'owner1', PoolOwner> = {
  owner0: {
...
const poolRewardAccounts: Record<
  'poolRewardAccountPath' | 'poolRewardAccountHash',
  PoolRewardAccount
> = {
...
export const poolRegistrationOwnerTestCases: SignTxTestCase[] = [
  ...
  },
  {
    ...
    testName: 'Sign_tx_Witness_pool_registration_with_no_metadata',
    appVersion: {unsupportedInAppXS: true},
    tx: {
      ...txBase,
  ...
  {
    testName: 'Sign_tx_Witness_pool_registration_without_outputs',
    appVersion: {unsupportedInAppXS: true},
    tx: {
      ...txBase,
      outputs: [],
