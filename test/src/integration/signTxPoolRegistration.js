...
describe("signTxPoolRetirement", async () => {
  let ada = {};
  ...
  it("Should correctly witness pool retirement combined with another certificate", async () => {
    ...
    const cert = certificates.poolRetirement;
    const response = await ada.signTransaction(
      ...
      sampleFeeStr,
      sampleTtlStr,
      [certificates.poolRetirement, certificates.stakeRegistration],
      [],
      undefined
    );
    expect(response).to.deep.equal(results.poolRetirement);
  });
});
